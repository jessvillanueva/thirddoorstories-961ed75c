...
const mapEntries: MapEntry[] = [
  ...
  { name: "O'Shaughnessy Fellowship", type: "Fellowship", location: "US", description: "$100K for ambitious people who want to build something great. 20 individuals plus access to OSV's network.", tags: ["Fellowships"], url: "https://www.osv.llc/fellowships" },
